...
public class VoiceLeftView extends RelativeLayout {
    ...
    protected VoiceLeftRecorder voiceRecorder;
    ...
    public VoiceLeftView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public VoiceLeftView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        voiceRecorder = new VoiceLeftRecorder(context, micImageHandler);
...
//                        Toast.makeText(context, "up" + length, Toast.LENGTH_SHORT).show();
                            if (length > 0) {
                                if (this.recorderCallback != null) {
                                    this.recorderCallback.onVoiceRecordComplete();
                                }
                            } else if (length == -1) {
